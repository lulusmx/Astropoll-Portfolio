...
function Photography({ onBack }) {
  ...
  if (view === 'phone') {
    const phonePhotos = [
      { src: '/images/phone-11.png', alt: 'Palmiers tropical' },
      { src: '/images/phone-12.png', alt: 'Mobylette' },
      { src: '/images/phone-14.png', alt: 'Salle de bain vue jardin' },
      { src: '/images/phone-6.png', alt: 'Photo 6' },
      { src: '/images/phone-10.png', alt: 'Photo 10' },
      { src: '/images/phone-8.png', alt: 'Photo 8' },
      { src: '/images/phone-9.png', alt: 'Photo 9' },
      { src: '/images/phone-7.png', alt: 'Photo 7' },
      { src: '/images/phone-13.png', alt: 'Poubelles plage' },
      { src: '/images/phone-2.png', alt: 'Photo 2' },
      { src: '/images/phone-3.png', alt: 'Photo 3' },
      { src: '/images/phone-5.png', alt: 'Photo 5' },
      { src: '/images/phone-4.png', alt: 'Photo 4' },
      { src: '/images/phone-1.png', alt: 'Photo 1' },
      { src: '/images/phone-16.png', alt: 'Deux chats' },
      { src: '/images/phone-17.png', alt: 'Street art timbres' },
      { src: '/images/phone-18.png', alt: 'Cour carrelage' },
      { src: '/images/phone-19.png', alt: 'Passage végétation' },
      { src: '/images/phone-20.png', alt: 'Arbre ciel bleu' },
      { src: '/images/phone-21.png', alt: 'Fenêtre à lamelles' },
      { src: '/images/phone-22.png', alt: 'Mur jaune graffiti' },
      { src: '/images/phone-23.png', alt: 'Vache et palmiers' },
      { src: '/images/phone-24.png', alt: 'Plage personne dos' },
      { src: '/images/phone-25.png', alt: 'Éclipse palmiers' },
      { src: '/images/phone-26.png', alt: 'Coucher de soleil végétation' },
      { src: '/images/phone-27.png', alt: 'Soleil horizon' },
      { src: '/images/phone-28.png', alt: 'Structure verte échelle' },
      { src: '/images/phone-29.png', alt: 'Côte mât turquoise' },
      { src: '/images/phone-30.png', alt: 'Rue grille colonial' },
      { src: '/images/phone-31.png', alt: 'Toit coucher de soleil' },
      { src: '/images/phone-32.png', alt: 'Arbre palmier mer' },
      { src: '/images/phone-33.png', alt: 'Marché fruits' },
      { src: '/images/phone-34.png', alt: 'Coucher de soleil toit palmiers' },
    ]
    return (
    ...
    const cameraSections = [
      {
        title: 'MANO. 2026 FEB',
        photos: [
          { src: '/images/camera-1-white-wall.png', alt: 'Sur mur blanc' },
          { src: '/images/camera-2-brick.png', alt: 'Mur brique' },
        ],
      },
      {
        title: 'MARVEL. 2026 JAN',
        photos: [
          { src: '/images/camera-3-marvel.png', alt: 'MARVEL' },
          {
            row: [
              { src: '/images/camera-marvel2.png', alt: 'MARVEL 2' },
              { src: '/images/camera-marvel3.png', alt: 'MARVEL 3' },
            ],
          },
        ],
      },
      {
        title: 'PAPA. 2025 NOV',
        photos: [
          { src: '/images/camera-papa.png', alt: 'PAPA' },
          {
            row: [
              { src: '/images/camera-papa2.png', alt: 'PAPA 2' },
              { src: '/images/camera-papa3.png', alt: 'PAPA 3' },
            ],
          },
          {
            row: [
              { src: '/images/camera-papa4.png', alt: 'PAPA 4' },
              { src: '/images/camera-papa5.png', alt: 'PAPA 5' },
            ],
          },
        ],
      },
      {
        ...
        photos: [
          { src: '/images/camera-fuego.png', alt: 'FUEGO' },
          {
            row: [
              { src: '/images/camera-fuego2.png', alt: 'FUEGO 2' },
              { src: '/images/camera-fuego3.png', alt: 'FUEGO 3' },
            ],
          },
        ],
      },
      {
        title: 'MANO. 2025 OCT',
        photos: [
          { src: '/images/camera-mano-oct.png', alt: 'MANO OCT' },
          {
            row: [
              { src: '/images/camera-mano-oct2.png', alt: 'MANO OCT 2' },
              { src: '/images/camera-mano-oct3.png', alt: 'MANO OCT 3' },
            ],
          },
          {
            row: [
              { src: '/images/camera-mano-oct4.png', alt: 'MANO OCT 4' },
              { src: '/images/camera-mano-oct5.png', alt: 'MANO OCT 5' },
            ],
          },
        ],
      },
      {
        title: 'ZAK. 2025 OCT',
        photos: [
          { src: '/images/camera-zak.png', alt: 'ZAK' },
          { src: '/images/camera-zak2.png', alt: 'ZAK 2' },
          {
            row: [
              { src: '/images/camera-zak3.png', alt: 'ZAK 3' },
              { src: '/images/camera-zak4.png', alt: 'ZAK 4' },
            ],
          },
          { src: '/images/camera-zak5.png', alt: 'ZAK 5' },
          { src: '/images/camera-zak6.png', alt: 'ZAK 6' },
        ],
      },
    ]
      ...
      <div className="page__content page__content--center">
        <div className="page__photo-wrap">
          <button type="button" className="page__photo-zone page__photo-zone--left" aria-label="Ouvrir la page Smartphone" onClick={() => setView('phone')}>
            <img src="/images/photography-menu.png" alt="" className="page__photo-half page__photo-half--left" draggable={false} />
          </button>
          <button type="button" className="page__photo-zone page__photo-zone--right" aria-label="Ouvrir la page Appareil photo" onClick={() => setView('camera')}>
            <img src="/images/appareil-photo.png" alt="Appareil photo" className="page__photo-half page__photo-half--right page__photo-half--icon" draggable={false} />
          </button>
        </div>
      </div>
    </div>
